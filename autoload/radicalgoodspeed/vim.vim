" Legacy Vim implementation for RadicalGoodSpeed.
" This file is loaded only in Vim (not Neovim).
" Neovim uses a Lua-based implementation by default.
" Set g:radicalgoodspeed_force_cterm=1 to force the Vimscript/cterm fallback in Neovim (this disables termguicolors).
" Vim always uses Vimscript.
...
function! radicalgoodspeed#vim#load() abort
  ...
  " Folds
  hi Folded           ctermfg=135 ctermbg=NONE guibg=NONE    guifg=#ae5ff2 gui=bold cterm=bold
